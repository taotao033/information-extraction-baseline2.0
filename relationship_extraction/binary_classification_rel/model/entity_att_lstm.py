...
class EntityAttentionLSTM:
    def __init__(self, sequence_length, num_classes,
        ...
        with tf.variable_scope('output'):
            ...
            self.predictions = tf.cast(tf.greater_equal(tf.sigmoid(self.logits), 0.5), tf.int32)
        ...
        with tf.variable_scope("accuracy"):
            ...
            correct_attrs_op = tf.equal(tf.cast(tf.greater_equal(tf.sigmoid(self.logits), 0.5), tf.int32),
