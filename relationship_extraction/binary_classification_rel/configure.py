...
def parse_args():
    ...
    parser.add_argument("--train_features_path", default="./data/",
                        type=str, help="Path of train data")
    parser.add_argument("--dev_features_path", default="./data/",
                        type=str, help="Path of test data")
    parser.add_argument("--test_features_path", default="./data/",
                        type=str, help="Path of test data")
