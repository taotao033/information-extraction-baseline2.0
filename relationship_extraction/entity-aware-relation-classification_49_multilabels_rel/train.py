            ...
            for train_batch in train_batches:
                ...
                if step % FLAGS.evaluate_every == 0:
                    ...
                    if best_f1 < logger.best_f1:
                        ...
                        with open("./predict_results/test1_49_multilabels_rel_predict_labels.txt", 'w') as test_pre:
                            for i in predictions_test:
                                ...
                                pre_label = ''
                                for la in temp:
                                    pre_label += utils.en_id2class()[la] + " "
                                pre_label = pre_label.strip()
                                test_pre.write(pre_label + "\n")
                        test_pre.close()
